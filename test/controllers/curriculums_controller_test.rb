...
class CurriculumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curriculum" do
    assert_difference('Curriculum.count') do
      post curriculums_url, params: { curriculum: { capacity: @curriculum.capacity, description: @curriculum.description, title: @curriculum.title } }
    end
  ...
  test "should update curriculum" do
    patch curriculum_url(@curriculum), params: { curriculum: { capacity: @curriculum.capacity, description: @curriculum.description, title: @curriculum.title } }
