...
nnoremap <silent> <expr>  n g:NERDTree.IsOpen() ? "\:NERDTreeClose" : bufexists(expand('%')) ? "\:NERDTreeFind" : "\:NERDTree"
...
set runtimepath=
set runtimepath+=~/.vim
set runtimepath+=~/.vim/pack/vendor/start/indentLine
...
set runtimepath+=~/.vim/plugged/pgsql.vim
...
set runtimepath+=~/.vim/plugged/vim-systemd-syntax
...
set runtimepath+=~/.vim/pack/vendor/start/indentLine/after
